...
public class StatsServiceImpl implements StatsService {
    ...
    public Map<String, BigDecimal> getDailyIncome() {
        ...
        BigDecimal total = orders.stream()
                ...
                .filter(order -> order.status() == OrderStatus.CONFIRMED || order.status() == OrderStatus.SHIPPED
    ...
    public Map<String, Long> getDailyBookings() {
        ...
        long count = bookings.stream()
                .filter(booking -> booking.createdAt() != null && booking.createdAt().toLocalDate().equals(today))
                .count();
    ...
    public ChartDataDto getMonthlyUsers() {
        List<UserDto> users = userRepository.findAll(1, 1000);
    ...
    public ChartDataDto getMonthlyReports() {
        List<ReportDto> reports = reportRepository.findAll(1, 1000);
